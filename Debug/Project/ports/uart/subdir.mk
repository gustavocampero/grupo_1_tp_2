...
C_SRCS += \
../Project/ports/uart/port_uart.c 

OBJS += \
./Project/ports/uart/port_uart.o 

C_DEPS += \
./Project/ports/uart/port_uart.d 


# Each subdirectory must supply rules for building sources it contributes
Project/ports/uart/%.o Project/ports/uart/%.su Project/ports/uart/%.cyclo: ../Project/ports/uart/%.c Project/ports/uart/subdir.mk
...
clean: clean-Project-2f-ports-2f-uart

clean-Project-2f-ports-2f-uart:
	-$(RM) ./Project/ports/uart/port_uart.cyclo ./Project/ports/uart/port_uart.d ./Project/ports/uart/port_uart.o ./Project/ports/uart/port_uart.su

.PHONY: clean-Project-2f-ports-2f-uart
